1. The personal access token was generated from github which was then used to scrape the data using github APIs. The scraped data is preprocessed and is stored in csv
